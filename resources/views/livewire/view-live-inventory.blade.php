<div>
    <div class="mx-auto w-full md:w-2/3 p-3">
        ...
        <p><b>Keywords</b>: Enter keywords related to the item you're searching for. This could include make, model, capacity, or any other relevant details.</p>
        ...
        <div class="bg-zinc-50 rounded-lg p-2">
            ...
            <div class="grid grid-flow-col auto-cols-max gap-2 p-4">
                ...
                @foreach ($keywords as $keyword)
                    <div class="inline-block whitespace-nowrap bg-cyan-600 text-center text-white px-4 py-1 rounded-full">{{$keyword}}</div>
                @endforeach
            </div>
        </div>
        @endempty
        <div class="flex flex-col lg:flex-row justify-between w-full gap-2">
            ...
            <button class="px-3 py-1.5 bg-cyan-700 text-white uppercase rounded-xl shadow-md font-bold" wire:click.prevent='resetFilter'>Reset</button>
        </div>
    </div>
