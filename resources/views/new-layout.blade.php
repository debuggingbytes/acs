        ...
        <section class="mb-16 container mx-auto p-2 mt-20"> 
            <div class="flex flex-col md:flex-row gap-1 md:gap-5 mt-10 justify-center items-center min-h-[60svh]">
                ...
                <div class="w-full md:w-1/2 flex flex-col h-full p-1 md:p-5">
                    ...
                    <a href="" wire:navigate class="flex justify-center items-center text-white mt-5 px-5 py-2 bg-sky-700 transition-all ease-in-out hover:bg-sky-900 mx-auto w-full md:w-1/3 gap-5">
                        Find out more
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-6">
        ...
        <section class="mb-16 container mx-auto p-2 mt-20"> 
            <div class="flex flex-col md:flex-row gap-1 md:gap-5 mt-10 justify-center items-center min-h-[50svh]">
                ...
                <div class="w-full md:w-1/2 flex flex-col h-full p-1 md:p-5">
                    ...
                    <a href="" wire:navigate class="flex justify-center items-center text-white mt-5 px-5 py-2 bg-orange-700 transition-all ease-in-out hover:bg-orange-900 mx-auto w-full md:w-1/3 gap-5">
                        Contact us today
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-6">
