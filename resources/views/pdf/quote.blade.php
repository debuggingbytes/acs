...
<body>
    <div class="quote-container">
        ...
        <div class="text-right mt-5" style="display: flex; width: 100%; justify-content: flex-end; text-align: right;">
            <a href="{{ route('crane', ['id' => $quote->inventory->id, 'slug' => $quote->inventory->craneInventory->slugName]) }}" class="web-button no-print" style="cursor: pointer; margin-top: 0;">View on Web</a>
        </div>
