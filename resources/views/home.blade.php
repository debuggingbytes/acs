        ...
        <div class="p-12 relative overflow-hidden bg-no-repeat bg-cover h-screen hero-bg">
            ...
            <div class="absolute top-0 right-0 bottom-0 left-0 w-full h-full overflow-hidden bg-fixed"
                ...
                <div class="flex justify-center items-center h-full w-3/4 lg:w-auto lg:px-20 mx-auto gap-10">
                    ...
                    <div class="w-full text-center lg:text-start lg:w-1/2">
                        <h1
                            ...
                            <span class="block text-sm md:text-xl text-white my-4 font-normal">
                                Alberta Crane Service has access to a vast inventory of used equipment and used cranes
                                for sale across
                  ...
                  " href="{{ route('inventory') }}" role="button" data-mdb-ripple="true"
                            data-mdb-ripple-color="light">View Inventory</a>
                    </div>
                    {{-- Scrolling Features --}}
                    <div class="w-1/3 relative hidden lg:block">
                        ...
                        <button id="prev"
                            class="hover:drop-shadow-md hover:font-bold hover:opacity-80 px-2 py-2 text-white font-semibold opacity-60 text-center">
    ...
    <main class="bg-slate-200 min-h-screen">
        ...
        <section id="services" class="py-10">
            <div class="md:container md:mx-auto p-4 ">
                <h2 class="text-3xl md:text-3xl text-cyan-800 mt-20 mb-5 font-bold uppercase ">Crane &amp; Equipment
                    Services</h2>
                <p class="mb-4 text-xl font-semibold">Alberta Crane Service Ltd. has a vast inventory of used cranes and
                    heavy equipment for sale, with stock located in the United States, Canada and Europe. </p>
                <p class="mb-10 text-xl font-semibold">Our inventory is always up to date to best serve you with all
                    your used equipment needs. Our inventory ranges from All Terrain Cranes, truck mounts, carry decks
                    &amp; other various crane parts like counter weights, maxxers, boom &amp; jib attachments.</p>

                <div class="flex flex-wrap gap-5 w-full items-center justify-center py-20">

                    <x-crane-card crane="All Terrain Cranes" route="all-terrain-crane"
                        image="img/all-terrain-crane.webp" />
                    <x-crane-card crane="Rough Terrain Cranes" route="rough-terrain-crane"
                        image="img/rough-terrain-crane.webp" />
                    <x-crane-card crane="Carry Deck Cranes" route="carry-deck-crane" image="img/crane3.webp" />
                    <x-crane-card crane="Truck Mount Cranes" route="truck-mounted-telescopic-boom-crane"
                        image="img/crane4.webp" />
                ...
                <p class="text-left md:text-lg my-4 mb-10">
                    The cost of a new crane or piece of heavy equipment is significant. The price tag is often out of
                    reach for
                    small and
                    medium-sized businesses. Buying used cranes, attachments or other equipment can be a great
                    alternative.
                    Buying used heavy equipment has several benefits that are worth considering. It provides an
                    opportunity to
                    save money, and it also offers the chance to invest in equipment that is generally well maintained.
                    Alberta
                    Crane Service has varying stock from Liebherr all-terrain cranes and crawler cranes, Tadano RTs to
                    Grove and
        ...
        <section id="cta" class="bg-gradient-to-b from-transparent to-cyan-700 pt-10 pb-20">
            <div class="min-h-96 md:container md:mx-auto md:p-4">
                ...
                <div class="md:flex items-center justify-between">
                        ...
                        <div class="block">
                            <p class="uppercase text-xl lg:text-2xl text-white font-bold pb-5 lg:pb-10">
                                <img src="{{ asset('img/acs-logo-new.png') }}" class="mx-auto"
                                    alt="Used Cranes for Sale">
                                {{-- <span class="text-cyan-800 block text-xl lg:text-4xl pb-5 lg:pb-10">Alberta Crane
                                    Service</span> --}}
                                also provides a variety of other services to help your business
                            </p>
                        </div>
                        <h3 class="break-words">
                            <span
                                class="block text-xl py-2 md:py-0` md:text-3xl text-white uppercase font-extrabold tracking-widest">
                    ...
                    {{-- Contact form --}}
                    <div
                        class="w-100 md:w-1/2 p-5 m-5 bg-slate-300 rounded-xl ring-1 ring-black drop-shadow-md shadow-sm ">
                        <x-forms.contact />
                    </div>
                </div>
            </div>
