...
<img src="{{ asset( $image ) }}" class="w-full h-48" alt="{{ $crane }}" loading="lazy"/>
<div class="crane block">
  ...
  <a wire:navigate href='{{ route('category', ['slug' => $route])}}' class="block bg-cyan-900 px-7 py-3 mx-2 my-5 rounded-xl text-center uppercase text-white font-semibold">
    View Inventory
  </a>
</div>
</div>
